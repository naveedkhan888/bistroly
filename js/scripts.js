        ...
        xp_core_interactive_link_showcase: {
            xpthemeInteractiveLinkShowcaseList: {
                init: function() {
                    ...
                    var $holders = $('[data-xptheme-interactive-links="list"]');
                    
                    if ($holders.length) {
                        $holders.each(function() {
                            var $el = $(this),
                                $container = $el.closest('.xptheme-interactive-link-showcase'),
                                $images = $container.find('.xptheme-m-image'),
                                $items = $container.find('.xptheme-m-item');
                            
                            // Reset first
                            $images.removeClass('xptheme--active');
                            $items.removeClass('xptheme--active');
                            ...
                            $items.on('mouseenter.xpthemeInteractiveLinks', function() {
                                var $this = $(this),
                                    index = $this.index();
                                
                                $images.removeClass('xptheme--active')
                                       .eq(index).addClass('xptheme--active');
                                $items.removeClass('xptheme--active')
                                      .eq(index).addClass('xptheme--active');
                            });
                ...
                // Add cleanup method
                destroy: function() {
                    $('[data-xptheme-interactive-links="list"]').each(function() {
                        var $el = $(this),
                            $container = $el.closest('.xptheme-interactive-link-showcase');
                        
                        $container.find('.xptheme-m-item').off('mouseenter.xpthemeInteractiveLinks');
                        $container.find('.xptheme--active').removeClass('xptheme--active');
                        $el.removeClass('xptheme--init');
                    });
                }
            }
        }
